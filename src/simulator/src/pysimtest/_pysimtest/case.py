...
class SimTestCase:
    ...
    def __init__(self, name):
        ...
        """
        self.name       = name
        self.use_ai     = const.DEFAULT_USE_AI 
...
class SimTestBuilder:
    ...
    def use_ai(self, use, is_global):
        if is_global:
            self._glob_use_ai = use
        else: 
            self._curr_test.use_ai = use
    ...
    def _set_globals(self):
        if self._glob_use_ai is not None:
            self._curr_test.use_ai = self._glob_use_ai
