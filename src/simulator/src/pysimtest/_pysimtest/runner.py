...
class SimRunner:
    ...
    def configure_simulation(self,test):
        ...
        vehicle, scene and objects, launches ai/dynamics if needed
    ...
    def stop_simulation(self):
        ...
        if self._uwsim_pgid is not None:
            ...
            self._uwsim_pgid = None
        if self._ai_pgid is not None:
            os.killpg(os.getpgid(self._ai_pgid), signal.SIGTERM)
            self._ai_pgid = None
