...
typedef struct tag_RTM_trajectory_planner_T RT_MODEL_trajectory_planner_T;
...
#ifndef typedef_i_cell_trajectory_planner_T
#define typedef_i_cell_trajectory_planner_T

typedef struct {
  real_T f3;
} i_cell_trajectory_planner_T;

#endif                                 //typedef_i_cell_trajectory_planner_T

#ifndef typedef_c_robotics_core_internal_code_T
#define typedef_c_robotics_core_internal_code_T

typedef struct {
  i_cell_trajectory_planner_T ParsedResults;
} c_robotics_core_internal_code_T;

#endif                                 //typedef_c_robotics_core_internal_code_T

#ifndef typedef_struct_T_trajectory_planner_T
#define typedef_struct_T_trajectory_planner_T

typedef struct {
  char_T Value[8];
} struct_T_trajectory_planner_T;

#endif                                 //typedef_struct_T_trajectory_planner_T
...
// Block signals and states (default storage) for model 'trajectory_planner'
typedef struct {
...
} DW_trajectory_planner_T;

// Real-time Model Data Structure
struct tag_RTM_trajectory_planner_T {
...
class trajectory_plannerModelClass {
 ...
 public:
  ...
  RT_MODEL_trajectory_planner_T * getRTM();
 ...
 private:
  ...
  DW_trajectory_planner_T trajectory_planner_DW;

  // Real-Time Model
  RT_MODEL_trajectory_planner_T trajectory_planner_M;
  ...
  void trajectory_planner_sum(const real_T x[12], real_T y[6]);
  void trajectory_planner_linspace(real_T d2, real_T y[2]);
  ...
  int32_T trajectory_planner_bsearch(const real_T x_data[], const int32_T
    x_size[2], real_T xi);
  void trajectory_planner_ppval(const real_T pp_breaks_data[], const int32_T
  ...
  void trajectory_planner_trapveltraj(const real_T wayPoints[18], real_T
  ...
  void trajectory_planner_ppval_o(const real_T pp_breaks_data[], const int32_T
...
//  '<S1>'   : 'trajectory_planner/MATLAB Function'
