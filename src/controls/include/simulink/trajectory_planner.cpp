...
// C/C++ source code generated on : Fri Mar 13 18:48:38 2020
//
...
void trajectory_plannerModelClass::trajectory_pla_SystemCore_setup
...
c_robotics_core_internal_code_T *trajectory_plannerModelClass::
  NameValueParser_NameValueParser(c_robotics_core_internal_code_T *obj)
{
  return obj;
}

boolean_T trajectory_plannerModelClass::traj_checkPolyForMultipleBreaks(const
  real_T breakMat[42])
{
...
void trajectory_plannerModelClass::trajec_processPolynomialResults(const real_T
...
void trajectory_plannerModelClass::trajectory_computeProfileParams(real_T i,
...
void trajectory_plannerModelClass::trajectory_planner_sum(const real_T x[12],
  real_T y[6])
{
  int32_T b_j;
  for (b_j = 0; b_j < 6; b_j++) {
...
void trajectory_plannerModelClass::trajectory_planner_linspace(real_T d2, real_T
  y[2])
{
  y[1] = d2;
  y[0] = 0.0;
...
void trajectory_plannerModelClass::t_computeScalarLSPBCoefficients(real_T s0,
...
void trajectory_plannerModelClass::tr_addFlatSegmentsToPPFormParts(const real_T
...
void trajectory_plannerModelClass::trajectory_polyCoeffsDerivative(const real_T
...
int32_T trajectory_plannerModelClass::trajectory_planner_bsearch(const real_T
...
void trajectory_plannerModelClass::trajectory_planner_ppval(const real_T
  ...
  v_size[2])
{
  ...
  if (pp_coefs_size[0] == 1) {
    if (rtIsNaN(x[0])) {
      ...
      ip = trajectory_planner_bsearch(pp_breaks_data, pp_breaks_size, x[0]) - 1;
    ...
    if (rtIsNaN(x[1])) {
      ...
      ip = trajectory_planner_bsearch(pp_breaks_data, pp_breaks_size, x[1]) - 1;
...
void trajectory_plannerModelClass::t_generateTrajectoriesFromCoefs(const real_T
  ...
  real_T pp_coefs_data[], int32_T pp_coefs_size[3])
{
  ...
  num[1] = num_idx_1;
  num[2] = 3;
  trajectory_planner_ppval(modBreaks_data_0, modBreaks_size_2, modCoeffs_data,
    num, t, q_data, q_size);
  ...
  num[2] = 3;
  trajectory_planner_ppval(modBreaks_data_0, modBreaks_size_1, dCoeffs_data, num,
    t, qd_data, qd_size);
  ...
  num[1] = modBreaks_size[1] - 1;
  num[2] = 3;
  trajectory_planner_ppval(modBreaks_data_0, modBreaks_size_0, tmp_data, num, t,
    qdd_data, qdd_size);
}

void trajectory_plannerModelClass::trajectory_planner_trapveltraj(const real_T
  ...
  *ppCell_size)
{
  ...
  trajec_processPolynomialResults(breakMat, coeffMat, hasMultipleBreaks,
    breaksCell, trajectory_planner_DW.coeffsCell);
  trajectory_planner_sum(&parameterMat[60], varargin_1);
  ...
  trajectory_planner_linspace(tFi, t);
  if (hasMultipleBreaks) {
    apnd = 6.0;
    tFi = 1.0;
  } else {
  ...
  *ppCell_size = static_cast<int32_T>(apnd);
  for (b_j = 0; b_j <= b_idx; b_j++) {
    ...
    t_generateTrajectoriesFromCoefs(breaksCell[static_cast<int32_T>(apnd) - 1].
      ...
      trajectory_planner_DW.coeffsCell[static_cast<int32_T>(apnd) - 1].f1.data,
      trajectory_planner_DW.coeffsCell[static_cast<int32_T>(apnd) - 1].f1.size,
...
void trajectory_plannerModelClass::TrapVelTrajSys_extract1DimFromP(const real_T
  pp_breaks_data[], const int32_T pp_breaks_size[2], const real_T pp_coefs_data[],
...
void trajectory_plannerModelClass::trajectory_planner_ppval_o(const real_T
  pp_breaks_data[], const int32_T pp_breaks_size[2], const real_T pp_coefs_data[],
  real_T x, real_T v_data[], int32_T *v_size)
{
  ...
  *v_size = 1;
  if (rtIsNaN(x)) {
    ...
    ip = trajectory_planner_bsearch(pp_breaks_data, pp_breaks_size, x) - 1;
...
void trajectory_plannerModelClass::TrapVelTrajSys_generate1DTrajec(const real_T
  ...
  qd_data[], int32_T *qd_size, real_T qdd_data[], int32_T *qdd_size)
{
  ...
  trajectory_planner_ppval_o(breaks_data_0, breaks_size_2, coefs_data, t, q_data,
    q_size);
  breaks_size_1[0] = 1;
  ...
  trajectory_planner_ppval_o(breaks_data_0, breaks_size_1, dCoefs_data, t,
    qd_data, qd_size);
  ...
  trajectory_planner_ppval_o(breaks_data_0, breaks_size_0, tmp_data, t, qdd_data,
    qdd_size);
}

void trajectory_plannerModelClass::TrapVelTrajSys_extract1DimFro_n(const real_T
  pp_breaks_data[], const int32_T pp_breaks_size[2], const real_T pp_coefs_data[],
  const int32_T pp_coefs_size[3], real_T breaks_data[], int32_T breaks_size[2],
  real_T oneDimCoeffs_data[], int32_T oneDimCoeffs_size[2])
{
...
void trajectory_plannerModelClass::TrapVelTrajSys_extract1DimFr_nd(const real_T
  pp_breaks_data[], const int32_T pp_breaks_size[2], const real_T pp_coefs_data[],
  const int32_T pp_coefs_size[3], real_T breaks_data[], int32_T breaks_size[2],
  real_T oneDimCoeffs_data[], int32_T oneDimCoeffs_size[2])
{
...
void trajectory_plannerModelClass::TrapVelTrajSys_extract1DimF_ndx(const real_T
  pp_breaks_data[], const int32_T pp_breaks_size[2], const real_T pp_coefs_data[],
  const int32_T pp_coefs_size[3], real_T breaks_data[], int32_T breaks_size[2],
  real_T oneDimCoeffs_data[], int32_T oneDimCoeffs_size[2])
{
...
void trajectory_plannerModelClass::TrapVelTrajSys_extract1Dim_ndxq(const real_T
  pp_breaks_data[], const int32_T pp_breaks_size[2], const real_T pp_coefs_data[],
  const int32_T pp_coefs_size[3], real_T breaks_data[], int32_T breaks_size[2],
  real_T oneDimCoeffs_data[], int32_T oneDimCoeffs_size[2])
{
...
void trajectory_plannerModelClass::TrapVelTrajSys_extract1Di_ndxqg(const real_T
  pp_breaks_data[], const int32_T pp_breaks_size[2], const real_T pp_coefs_data[],
  const int32_T pp_coefs_size[3], real_T breaks_data[], int32_T breaks_size[2],
  real_T oneDimCoeffs_data[], int32_T oneDimCoeffs_size[2])
{
...
void trajectory_plannerModelClass::traject_TrapVelTrajSys_stepImpl(real_T time,
  ...
  real_T qdd[6])
{
  ...
  trajectory_planner_trapveltraj(varargin_1, varargin_2, unusedU8, unusedU9,
    unusedUa, unusedUb, trajectory_planner_DW.trajPP.data,
    &trajectory_planner_DW.trajPP.size);
  if (trajectory_planner_DW.trajPP.size > 1) {
    breaks_size[0] = 1;
    breaks_size[1] = trajectory_planner_DW.trajPP.data[0].breaks.size[1];
    loop_ub = trajectory_planner_DW.trajPP.data[0].breaks.size[1];
    for (oneDimCoeffs_size_tmp = 0; oneDimCoeffs_size_tmp < loop_ub;
         oneDimCoeffs_size_tmp++) {
      breaks_data[oneDimCoeffs_size_tmp] = trajectory_planner_DW.trajPP.data[0].
        breaks.data[oneDimCoeffs_size_tmp];
    }

    oneDimCoeffs_size_tmp = trajectory_planner_DW.trajPP.data[0].coefs.size[0] *
      trajectory_planner_DW.trajPP.data[0].coefs.size[1] * 3 / 3;
    oneDimCoeffs_size[0] = oneDimCoeffs_size_tmp;
    loop_ub = oneDimCoeffs_size_tmp * 3 - 1;
    for (oneDimCoeffs_size_tmp = 0; oneDimCoeffs_size_tmp <= loop_ub;
         oneDimCoeffs_size_tmp++) {
      oneDimCoeffs_data[oneDimCoeffs_size_tmp] =
        trajectory_planner_DW.trajPP.data[0].coefs.data[oneDimCoeffs_size_tmp];
    }
  } else {
    TrapVelTrajSys_extract1DimFromP(trajectory_planner_DW.trajPP.data[0].
      breaks.data, trajectory_planner_DW.trajPP.data[0].breaks.size,
      trajectory_planner_DW.trajPP.data[0].coefs.data,
      trajectory_planner_DW.trajPP.data[0].coefs.size, breaks_data, breaks_size,
  ...
  if (trajectory_planner_DW.trajPP.size > 1) {
    breaks_size[0] = 1;
    breaks_size[1] = trajectory_planner_DW.trajPP.data[1].breaks.size[1];
    loop_ub = trajectory_planner_DW.trajPP.data[1].breaks.size[1];
    for (oneDimCoeffs_size_tmp = 0; oneDimCoeffs_size_tmp < loop_ub;
         oneDimCoeffs_size_tmp++) {
      breaks_data[oneDimCoeffs_size_tmp] = trajectory_planner_DW.trajPP.data[1].
        breaks.data[oneDimCoeffs_size_tmp];
    }

    oneDimCoeffs_size_tmp = trajectory_planner_DW.trajPP.data[1].coefs.size[0] *
      trajectory_planner_DW.trajPP.data[1].coefs.size[1] * 3 / 3;
    oneDimCoeffs_size[0] = oneDimCoeffs_size_tmp;
    loop_ub = oneDimCoeffs_size_tmp * 3 - 1;
    for (oneDimCoeffs_size_tmp = 0; oneDimCoeffs_size_tmp <= loop_ub;
         oneDimCoeffs_size_tmp++) {
      oneDimCoeffs_data[oneDimCoeffs_size_tmp] =
        trajectory_planner_DW.trajPP.data[1].coefs.data[oneDimCoeffs_size_tmp];
    }
  } else {
    TrapVelTrajSys_extract1DimFro_n(trajectory_planner_DW.trajPP.data[0].
      breaks.data, trajectory_planner_DW.trajPP.data[0].breaks.size,
      trajectory_planner_DW.trajPP.data[0].coefs.data,
      trajectory_planner_DW.trajPP.data[0].coefs.size, breaks_data, breaks_size,
      oneDimCoeffs_data, oneDimCoeffs_size);
  ...
  if (trajectory_planner_DW.trajPP.size > 1) {
    breaks_size[0] = 1;
    breaks_size[1] = trajectory_planner_DW.trajPP.data[2].breaks.size[1];
    loop_ub = trajectory_planner_DW.trajPP.data[2].breaks.size[1];
    for (oneDimCoeffs_size_tmp = 0; oneDimCoeffs_size_tmp < loop_ub;
         oneDimCoeffs_size_tmp++) {
      breaks_data[oneDimCoeffs_size_tmp] = trajectory_planner_DW.trajPP.data[2].
        breaks.data[oneDimCoeffs_size_tmp];
    }

    oneDimCoeffs_size_tmp = trajectory_planner_DW.trajPP.data[2].coefs.size[0] *
      trajectory_planner_DW.trajPP.data[2].coefs.size[1] * 3 / 3;
    oneDimCoeffs_size[0] = oneDimCoeffs_size_tmp;
    loop_ub = oneDimCoeffs_size_tmp * 3 - 1;
    for (oneDimCoeffs_size_tmp = 0; oneDimCoeffs_size_tmp <= loop_ub;
         oneDimCoeffs_size_tmp++) {
      oneDimCoeffs_data[oneDimCoeffs_size_tmp] =
        trajectory_planner_DW.trajPP.data[2].coefs.data[oneDimCoeffs_size_tmp];
    }
  } else {
    TrapVelTrajSys_extract1DimFr_nd(trajectory_planner_DW.trajPP.data[0].
      breaks.data, trajectory_planner_DW.trajPP.data[0].breaks.size,
      trajectory_planner_DW.trajPP.data[0].coefs.data,
      trajectory_planner_DW.trajPP.data[0].coefs.size, breaks_data, breaks_size,
      oneDimCoeffs_data, oneDimCoeffs_size);
  ...
  if (trajectory_planner_DW.trajPP.size > 1) {
    breaks_size[0] = 1;
    breaks_size[1] = trajectory_planner_DW.trajPP.data[3].breaks.size[1];
    loop_ub = trajectory_planner_DW.trajPP.data[3].breaks.size[1];
    for (oneDimCoeffs_size_tmp = 0; oneDimCoeffs_size_tmp < loop_ub;
         oneDimCoeffs_size_tmp++) {
      breaks_data[oneDimCoeffs_size_tmp] = trajectory_planner_DW.trajPP.data[3].
        breaks.data[oneDimCoeffs_size_tmp];
    }

    oneDimCoeffs_size_tmp = trajectory_planner_DW.trajPP.data[3].coefs.size[0] *
      trajectory_planner_DW.trajPP.data[3].coefs.size[1] * 3 / 3;
    oneDimCoeffs_size[0] = oneDimCoeffs_size_tmp;
    loop_ub = oneDimCoeffs_size_tmp * 3 - 1;
    for (oneDimCoeffs_size_tmp = 0; oneDimCoeffs_size_tmp <= loop_ub;
         oneDimCoeffs_size_tmp++) {
      oneDimCoeffs_data[oneDimCoeffs_size_tmp] =
        trajectory_planner_DW.trajPP.data[3].coefs.data[oneDimCoeffs_size_tmp];
    }
  } else {
    TrapVelTrajSys_extract1DimF_ndx(trajectory_planner_DW.trajPP.data[0].
      breaks.data, trajectory_planner_DW.trajPP.data[0].breaks.size,
      trajectory_planner_DW.trajPP.data[0].coefs.data,
      trajectory_planner_DW.trajPP.data[0].coefs.size, breaks_data, breaks_size,
      oneDimCoeffs_data, oneDimCoeffs_size);
  ...
  if (trajectory_planner_DW.trajPP.size > 1) {
    breaks_size[0] = 1;
    breaks_size[1] = trajectory_planner_DW.trajPP.data[4].breaks.size[1];
    loop_ub = trajectory_planner_DW.trajPP.data[4].breaks.size[1];
    for (oneDimCoeffs_size_tmp = 0; oneDimCoeffs_size_tmp < loop_ub;
         oneDimCoeffs_size_tmp++) {
      breaks_data[oneDimCoeffs_size_tmp] = trajectory_planner_DW.trajPP.data[4].
        breaks.data[oneDimCoeffs_size_tmp];
    }

    oneDimCoeffs_size_tmp = trajectory_planner_DW.trajPP.data[4].coefs.size[0] *
      trajectory_planner_DW.trajPP.data[4].coefs.size[1] * 3 / 3;
    oneDimCoeffs_size[0] = oneDimCoeffs_size_tmp;
    loop_ub = oneDimCoeffs_size_tmp * 3 - 1;
    for (oneDimCoeffs_size_tmp = 0; oneDimCoeffs_size_tmp <= loop_ub;
         oneDimCoeffs_size_tmp++) {
      oneDimCoeffs_data[oneDimCoeffs_size_tmp] =
        trajectory_planner_DW.trajPP.data[4].coefs.data[oneDimCoeffs_size_tmp];
    }
  } else {
    TrapVelTrajSys_extract1Dim_ndxq(trajectory_planner_DW.trajPP.data[0].
      breaks.data, trajectory_planner_DW.trajPP.data[0].breaks.size,
      trajectory_planner_DW.trajPP.data[0].coefs.data,
      trajectory_planner_DW.trajPP.data[0].coefs.size, breaks_data, breaks_size,
      oneDimCoeffs_data, oneDimCoeffs_size);
  ...
  if (trajectory_planner_DW.trajPP.size > 1) {
    breaks_size[0] = 1;
    breaks_size[1] = trajectory_planner_DW.trajPP.data[5].breaks.size[1];
    loop_ub = trajectory_planner_DW.trajPP.data[5].breaks.size[1];
    for (oneDimCoeffs_size_tmp = 0; oneDimCoeffs_size_tmp < loop_ub;
         oneDimCoeffs_size_tmp++) {
      breaks_data[oneDimCoeffs_size_tmp] = trajectory_planner_DW.trajPP.data[5].
        breaks.data[oneDimCoeffs_size_tmp];
    }

    oneDimCoeffs_size_tmp = trajectory_planner_DW.trajPP.data[5].coefs.size[0] *
      trajectory_planner_DW.trajPP.data[5].coefs.size[1] * 3 / 3;
    oneDimCoeffs_size[0] = oneDimCoeffs_size_tmp;
    loop_ub = oneDimCoeffs_size_tmp * 3 - 1;
    for (oneDimCoeffs_size_tmp = 0; oneDimCoeffs_size_tmp <= loop_ub;
         oneDimCoeffs_size_tmp++) {
      oneDimCoeffs_data[oneDimCoeffs_size_tmp] =
        trajectory_planner_DW.trajPP.data[5].coefs.data[oneDimCoeffs_size_tmp];
    }
  } else {
    TrapVelTrajSys_extract1Di_ndxqg(trajectory_planner_DW.trajPP.data[0].
      breaks.data, trajectory_planner_DW.trajPP.data[0].breaks.size,
      trajectory_planner_DW.trajPP.data[0].coefs.data,
      trajectory_planner_DW.trajPP.data[0].coefs.size, breaks_data, breaks_size,
      oneDimCoeffs_data, oneDimCoeffs_size);
...
// Start for referenced model: 'trajectory_planner'
void trajectory_plannerModelClass::start(void)
{
  // Start for MATLABSystem: '<Root>/Trapezoidal Velocity Profile Trajectory'
  trajectory_planner_DW.obj.EndTime[0] = 1.0;
  trajectory_planner_DW.obj.EndTime[1] = 1.0;
  trajectory_planner_DW.obj.isInitialized = 0;
  trajectory_planner_DW.objisempty = true;
  trajectory_pla_SystemCore_setup(&trajectory_planner_DW.obj);
}

// Output and update for referenced model: 'trajectory_planner'
void trajectory_plannerModelClass::step(real_T arg_time, const real_T
  ...
  arg_eta_d_dot_dot[6])
{
  ...
  if (trajectory_planner_DW.obj.TunablePropsChanged) {
    trajectory_planner_DW.obj.TunablePropsChanged = false;
  }
...
void trajectory_plannerModelClass::initialize()
{
  // Registration code
...
RT_MODEL_trajectory_planner_T * trajectory_plannerModelClass::getRTM()
{
  return (&trajectory_planner_M);
}

// member function to setup error status pointer
void trajectory_plannerModelClass::setErrorStatusPointer(const char_T
  **rt_errorStatus)
{
  rtmSetErrorStatusPointer((&trajectory_planner_M), rt_errorStatus);
}
