...
Controller::Controller()
  : imu_angular_velocity_(3, 1),
    ...
    ki_ << -4.8922, 4.7175, 0.0424, -0.0000, -0.0000, -1.6231, -4.1080, -5.8281,
    -0.0439, 0.0000, 0.0000, 1.7127, 0.1307, -2.5481, -1.8883, 0.0000, 0.0000,
    -3.2061, -0.1489, 2.8989, -1.8216, -0.0000, 0.0000, 3.2437;
    k_ << 0.333, -0.1862, -0.4010, -0.1260, 0.0019, 0.1623, 1.4647, -0.6226,
    -0.0760, 0.2136, 0.0016, 0.1497, 0.280, 0.2301, 0.4448, 0.1284, -0.0019,
    -0.1713, 1.4973, 0.6371, 0.0845, -0.2133, 0.0015, -0.1565, -0.008, 0.1006,
    14.5062, 0.1082, -0.0050, 0.3206, -0.0413, 0.8910, 2.6541, -0.0839, 0.0449,
    0.3121, 0.010, -0.1144, 13.8843, 0.8328, -0.0030, -0.3244, 0.0462, -0.9390,
    2.7067, 0.0779, 0.0449, -0.3149;
}
...
Eigen::MatrixXd Controller::setDesiredVelocity(double linear_x,
    ...
    current_velocity_(3, 0), current_velocity_(4, 0), current_velocity_(5, 0);
    x_ << current_velocity_(0, 0), current_velocity_(1, 0),
