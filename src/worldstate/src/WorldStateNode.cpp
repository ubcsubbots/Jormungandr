...
// */
// void WorldStateNode::gateDetectCallBack(const
// gate_detect::gateDetectMsgConstPtr & msg) {
//    worldstate::state_msg gateDetMsg;
//    double distBtwnHorizontalGatePole = fabs(msg->distanceLeft -
//    msg->distanceRight);
//    float errorTolerance = 0.25; // Assume an error tolerance of 25 cm
//    float clearanceHeight = 0.1; // Assume that sub requires 10 cm of
//    clearance to pass
//
...
//         * in which case the output is "passingGate." This is under the
//         assumption
...
//
//        /* State! G = 1
//         * output is "aligningWithGate" A pole has been found and the robot
//         should
//         * take the appropriate maneuvers to align with the gate
//         appropriately.
//         */
//
//        /* State! G = 2 or 3
//         * - If g_1, g_2, and g_3, and |D_1 - D_2| < error and D_3 >=
//         clearance then "passingGate"
...
//                    if (distBtwnHorizontalGatePole < errorTolerance &&
//                    msg->distanceTop >= clearanceHeight)
...
//
//
//            //If the poles suddenly disappear from view, assume the robot has
//            bee-lined and
